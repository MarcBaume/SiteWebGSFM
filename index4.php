...
<fieldset>
	<center>
       <video id="audioPlayer"width="600px">
	    <source src="../club.webm"></source>
		<source src="gsfm.mp4"></source>
      </video></br>
	  <input type="image" src="../images/no_volume.png" title="Ã©teindre le son"width="60" height="60"onclick="volume('audioPlayer')">
      <input type="image" src="../images/pause.png" title="pause"width="60" height="60"onclick="play('audioPlayer', this)">
	    <input type="image" src="../images/stop.png" title="stop"width="60" height="60"onclick="resume('audioPlayer')">
	<script>
	volume2('audioPlayer');
...
Le départ des enfants se situe devant la halle de gym </br></p>
 </br>
 <center>
...
parcours et sera établi avec le cumul des temps des <b>3</b> membres de l'équipe.</br></br>
 <b> Inscriptions des équipes gratuites,  chaque personne de l'équipe doit déjà être inscrite en individuel </b></br></p>
	  <li><a href="formulaire_equipe.php">Inscriptions équipe</a></li>
	  </fieldset>
	  </div>
...
<fieldset>
<p>
Le relais peut se faire à 2 ou à 3, il se fait sur le petit parcours et est divisé en 3 relais de 2.4km. </br>
L'accès aux zones de relais se fera à pied, encadré par des organisateurs.</br></p>
	  <li><a href="formulaire_relais.php">Inscriptions relais</a></li>
</fieldset>
</div>
...
Des restaurations chaudes sont à votre disposition dans la halle de gym.</br></p>
	...
	<Div id="main">
<h3>Délai  et frais d'inscription</h3>
<fieldset>
<p>
