...
<?php include("head.php"); ?>
   ...
   <center>
<img style="width:100%" src="images/couvertureCF22.jpg">
...
var ICounterCoureurs = 0;
		...
		<!--- Liste des parcours !---->
		<?php
		$DateCourse =  date_parse("2022-06-17");
...
<a style="font-size: 24px;" href="photo.php" target="_blank">Photos ici </a>
  ...
  <p> <b>  Date : </b>16 juin 2023 </P>
  <p>  <b> Lieu : </b> Le Noirmont </P>
  <p>  <b> Emplacement : </b>Halle polyvalente </P>
...
<p>
<a style="font-size: 24px;" href="/pdf/Programme 2022 A5.pdf" target="_blank">Programme 2022 </a>
</p>
<p>
<a style="font-size: 24px;" href="/pdf/Règlement 2022.pdf" target="_blank">Règlement 2022</a>
</p>
<?php 
