...
<center>
<img style="width:100%" src="images/couvertureVerticale2022.jpg">
</img>
</center>
...
<p>
<b style="font-size: 24px;">Inscription uniquement en ligne jusqu'à 21:00 samedi 5 novembre </b>
</p>
<?
$PathFolderPhoto = $pathfolder."/info/Photos";
...
?>
 ...
 <a>
 <center>
 <img style = Height:600px; id="Photos"></img> 
</center>
</a>
<?
} 
...
<div class="title">	Programme de la journée  </div>

	<p>
 <b>7:30 à 09:00 </b> Remise des dossards à la halle polyvalente des Bois </p>
 <p><b> 09:00 à 09:30 </b> Dépose des sacs dans une voiture au départ à Biaufond </p>
 <p><b>09:30 à 09:45 </b> 	Le départ de la course sera donné en 4 blocs espacés de quelques minutes dès 9h30</p>
 <p><b> 10:30 à 13:00 </b> Raclette party</p>
 <p><b> 11:30 </b> Remise des prix et tirage au sort </p>



<div class="title">	Vestiaires , douches et ravitaillement </div>
<p>
Les douches chaudes et les vestiaires vous attendront à la Halle Polyvalente des Bois. </p>
<p>Un ravitaillement vous sera proposé à l’arrivée.</p>
<p>Une cantine avec boissons et une bonne raclette vous permettra ensuite de récupérer de votre effort. </p>


<div class="title">	Informations complémentaires </div>

	<p>
  Il est demandé aux coureurs de rejoindre le départ par leurs propres moyens, de préférence en courant comme échauffement ou bien en covoiturage. L'accès au départ se fait par un chemin qui sera balisé. Ne pas utiliser le parcours de la course pour descendre. Voir plan ci-dessous </br></br>
  Les places de parking sont limitées à proximité du départ. Merci de n’utiliser que les parkings à disposition et ne pas entraver la circulation</br></br>
  Vous pourrez laisser un sac avec vos affaires dans une voiture au départ que vous retrouverez à l’arrivée. Merci de bien l’identifier, nous déclinons toutes responsabilités en cas de perte ou de vol </br></br>
</p>


<div class="title">Le défi des chamois  </div>

<p><B> Participe à ces deux courses pour être classé à ce défi </b></p>


<p style="margin-left:20px">
      <b> -> <a href="https://www.moutier-graitery.ch/course-puissants.html"> La course des Puissants (Moutier-Graitery) le 1er octobre<a></B></p>
	  <p style="margin-left:20px">	  <b> -> La verticale des Franches</b></p></br> 

	   <p >La course des Puissants (Moutier-Graitery) et la Verticale des Franches le 6 novembre aux Bois s'unissent pour vous offrir 14 km, + 1'430 m et - 400 m de bonheur. 
		Le et la première sont récompensés, tout comme 5 autres coureurs via un tirage au sort lors des remises des prix. 
		Le classement général est établi comme suit:  temps course des Puissants divisé par 2 + temps de la verticale des Franches.
		 Il suffit de participer aux 2 courses pour participer automatiquement au défi.</p>
<center>
  <img style="Height:600px;" src="images/planVerticale.jpg">
</center>
